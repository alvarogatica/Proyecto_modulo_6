...
const {createUser, loginUser, verifyUser, getAllUsers, updateUserById, deleteUserById  } = require('../controllers/user.controller');
...
userRouter.get('/', auth, getAllUsers); //Localhost:3000/api/users/
